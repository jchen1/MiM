	...
	var req = http.get(options, function(res)
			   {
			       ...
			       res.on('end', function()
					  ...
					  if (typeof JSONData.response.posts == 'undefined') {
					      //TODO: FIX THIS
					      console.log('derpderp JSONData.response.posts is undefined');
					  } else if (JSONData.response.posts[0].type === 'photo' && JSONData.response.posts[0].photos[0].original_size.url.indexOf('.gif') == -1)
					  {
